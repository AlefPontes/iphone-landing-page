    ...
    <section className="bg-black py-20 px-6">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center items-center mb-16">
          <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-full text-lg font-medium transition-all duration-300 hover:scale-103 shadow-lg shadow-blue-500/30 cursor-pointer">
            Compre Agora
          </button>
          <button className="border-2 border-white rounded-full hover:bg-white/85 hover:text-black text-white/80 px-8 py-4 text-lg font-medium ransition-all duration-300 hover:scale-103 shadow-lg shadow-white-500/30 cursor-pointer">
            Saiba Mais
          </button>
        </div>
      </div>
